...
class Target {
   ...
   */
  async page() {
    if ((this._targetInfo.type === 'page' || this._targetInfo.type === 'background_page' || this._targetInfo.type === 'app' || this._targetInfo.type === 'webview' || this._targetInfo.type === 'browser') && !this._pagePromise) {
  ...
  type() {
    ...
    if (type === 'page' || type === 'background_page' || type === 'service_worker' || type === 'browser' || type === 'app' || type === 'webview')
      return type;
    return 'other';
  }
