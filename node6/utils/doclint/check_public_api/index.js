 ...
 */
module.exports = /* async */ function lint(page, mdSources, jsSources) {return (fn => {
  ...
  const mdResult = (yield mdBuilder(page, mdSources));
  const jsResult = (yield jsBuilder(jsSources));
