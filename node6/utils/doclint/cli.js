...
/* async */ function run() {return (fn => {
  ...
  {
    const readme = (yield Source.readFile(path.join(PROJECT_DIR, 'README.md')));
    const api = (yield Source.readFile(path.join(PROJECT_DIR, 'docs', 'api.md')));
    ...
    const jsSources = (yield Source.readdir(path.join(PROJECT_DIR, 'lib'), '.js'));
