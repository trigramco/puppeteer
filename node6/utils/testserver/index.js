...
class TestServer {
   ...
   * @return {!TestServer}
   */
  static /* async */ create(dirPath, port) {return (fn => {
  ...
  return new Promise((resolve, reject) => {
    ...
    (yield new Promise(x => server._server.once('listening', x)));
    return server;
  });}
   ...
   * @return {!TestServer}
   */
  static /* async */ createHTTPS(dirPath, port) {return (fn => {
  const gen = fn.call(this);
  return new Promise((resolve, reject) => {
    function step(key, arg) {
      let info, value;
  ...
  return new Promise((resolve, reject) => {
    ...
    for (const socket of this._sockets)
      socket.destroy();
    this._sockets.clear();
    (yield new Promise(x => this._server.close(x)));
  });}
